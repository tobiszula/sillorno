/* =============================================================================
   ...
   · PRECIO      -> buscá el producto y cambiá el número en "precio".
                    Se escribe sin puntos ni comas: 24402.84
    ...
    productos: [
      ...
      /* ---------------------- TOALLAS Y TOALLONES ---------------------- */
      {
        ...
        variantes: [
          ...
          { medida: "70 × 140 cm", detalle: "Toallón",    precio: 18564.77, stock: "disponible" },
          { medida: "45 × 80 cm",  detalle: "Toalla",     precio: 8074.57,  stock: "disponible" },
        ],
      },
      {
        id: "toallon-velour",
        ...
        variantes: [
          { medida: "85 × 150 cm", detalle: "Toallón XL", precio: 23987.26, stock: "disponible" },
          { medida: "70 × 140 cm", detalle: "Toallón",    precio: 18788.48, stock: "disponible" },
          { medida: "45 × 80 cm",  detalle: "Toalla",     precio: 7697.82,  stock: "disponible" },
        ],
      },
      {
        id: "toallon-dominus",
        ...
        variantes: [
          { medida: "75 × 150 cm", detalle: "Toallón XL", precio: 14723.57, stock: "disponible" },
          { medida: "70 × 140 cm", detalle: "Toallón",    precio: 12988.91, stock: "disponible" },
          { medida: "45 × 80 cm",  detalle: "Toalla",     precio: 5571.74,  stock: "disponible" },
        ],
      },
      {
        id: "toallon-galaxy",
        ...
        variantes: [
          { medida: "75 × 150 cm", detalle: "Toallón XL", precio: 13328.11, stock: "disponible" },
          { medida: "70 × 140 cm", detalle: "Toallón",    precio: 11434.70, stock: "disponible" },
          { medida: "45 × 80 cm",  detalle: "Toalla",     precio: 5125.19,  stock: "disponible" },
        ],
      },
      {
        id: "toallon-loft",
        ...
        variantes: [
          { medida: "70 × 130 cm", detalle: "Toallón", precio: 11611.97, stock: "disponible" },
          { medida: "45 × 70 cm",  detalle: "Toalla",  precio: 4969.29,  stock: "disponible" },
        ],
      },
      {
        id: "toallon-remix",
        ...
        variantes: [
          { medida: "70 × 140 cm", detalle: "Toallón", precio: 12931.64, stock: "disponible" },
          { medida: "45 × 80 cm",  detalle: "Toalla",  precio: 5521.98,  stock: "disponible" },
        ],
      },
      {
        id: "toallon-eletra",
        ...
        variantes: [
          { medida: "70 × 140 cm", detalle: "Toallón", precio: 10222.52, stock: "disponible" },
          { medida: "45 × 80 cm",  detalle: "Toalla",  precio: 4046.13,  stock: "disponible" },
        ],
      },
      {
        id: "toallon-vegas",
        ...
        variantes: [
          { medida: "62 × 130 cm", detalle: "Toallón", precio: 9072.12, stock: "disponible" },
          { medida: "45 × 70 cm",  detalle: "Toalla",  precio: 4076.25, stock: "disponible" },
        ],
      },
      {
        id: "piso-supreme",
        ...
        colores: ["piscina", "azul marino", "azul", "rosa", "vino", "concreto",
                  "gris", "marrón", "blanco"],
        variantes: [
          { medida: "50 × 70 cm", detalle: "Piso", precio: 7404.10, stock: "disponible" },
        ],
      },
      ...
      },
      {
        ...
        variantes: [
          { medida: "1 plaza",  detalle: "Plana 160×240 · Ajustable 88×188×30 · Funda 70×50",
            precio: 22225.98, stock: "disponible" },
          { medida: "2 plazas", detalle: "Plana 220×240 · Ajustable 138×188×30 · Funda 70×50",
            precio: 28575.05, stock: "disponible" },
          { medida: "Queen",    detalle: "Plana 240×260 · Ajustable 158×198×35 · Funda 70×50",
            precio: 30406.46, stock: "disponible" },
        ],
      },
      {
      ...
      /* ------------------------- ALMOHADAS ----------------------------- */
      {
        ...
        variantes: [
          { medida: "50 × 70 cm", detalle: "Soporte medio", precio: 29906.12, stock: "disponible" },
          { medida: "50 × 90 cm", detalle: "Soporte medio", precio: 38702.03, stock: "disponible" },
        ],
      },
      {
        ...
        variantes: [
          { medida: "50 × 70 cm", detalle: "Con fuelle de 5 cm", precio: 16528.38, stock: "disponible" },
        ],
      },
      {
        ...
        specs: ["Fibra siliconada", "Toque de algodón", "Soporte firme",
                "Envasada al vacío"],
        variantes: [
          { medida: "50 × 70 cm", detalle: "Soporte firme", precio: 12380.39, stock: "disponible" },
        ],
      },
      ...
      /* --------------------- FRAZADAS Y MANTAS ------------------------- */
      {
        ...
        variantes: [
          { medida: "150 × 220 cm", detalle: "1 plaza",  precio: 25484.76, stock: "disponible" },
          { medida: "180 × 220 cm", detalle: "2 plazas", precio: 29242.22, stock: "disponible" },
          { medida: "220 × 240 cm", detalle: "Queen",    precio: 36757.16, stock: "disponible" },
          { medida: "240 × 260 cm", detalle: "King",     precio: 42334.36, stock: "disponible" },
        ],
      },
      {
        ...
        variantes: [
          { medida: "150 × 220 cm", detalle: "1 plaza",  precio: 15167.28, stock: "disponible" },
          { medida: "180 × 220 cm", detalle: "2 plazas", precio: 17310.13, stock: "disponible" },
          { medida: "220 × 240 cm", detalle: "Queen",    precio: 21595.79, stock: "disponible" },
        ],
      },
      {
        id: "manta-outlet",
        ...
        variantes: [
          { medida: "150 × 200 cm", detalle: "Medida única", precio: 13129.97, stock: "disponible" },
        ],
      },
      ...
      /* ------------------------ REPASADORES ---------------------------- */
      {
        ...
        variantes: [
          { medida: "42 × 60 cm", detalle: "Medida única", precio: 1609.43, stock: "disponible" },
        ],
      },
    ],
    ...
    combos: [
      {
        ...
        descripcion: "Toallón XL, toallón y toalla de mano en el mismo color.",
        img: "assets/img/toallon-icone.webp",
        descuento: 0.10,
        items: [
      ...
      },
      {
        ...
        descripcion: "Toallón, toalla y dos repasadores. Listo para entregar.",
